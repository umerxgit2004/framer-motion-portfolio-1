...
const Contact = () => {
  ...
  return (
    <motion.div ref={ref} className="contact" variants={variants} initial="inital" whileInView = "animate">
      <motion.div className="textContainer" variants={variants}>
        <motion.h1  variants={variants}>Lets work together</motion.h1>
        <motion.div className="item"  variants={variants}>
            <h2>Mail</h2>
            <span>umer.workplace174@gmail.com</span>
        </motion.div>
        <motion.div className="item"  variants={variants}>
            <h2>Address</h2>
      ...
      <div className="formContainer">
        ...
        <motion.form
          ...
          transition={{delay:4,duration:1}} >
            ...
            <textarea rows={8} placeholder="Messsage"/>
